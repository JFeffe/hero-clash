import {cleanSpriteMatte,cleanGreenMatte} from './sprite-matte.js?v=0.8.0';
let sheet=null,mageSheet=null,pending;
...
export function loadAtlas(){
 ...
 pending=Promise.all([loadSheet('./assets/warrior-wolf-v1.webp',cleanSpriteMatte),loadSheet('./assets/mage-v1.webp',cleanGreenMatte)]).then(([w,m])=>{sheet=w;mageSheet=m;return Boolean(w||m);});return pending;
}
