import {FAMILIARS,prepareFamiliars} from './familiar-art.js?v=0.21.0';
import {prepareRetro} from './retro-art.js?v=0.21.0';
import {prepareWarriorBodies} from './warrior-identity.js';
import {appearanceOf,validAppearance} from './appearance.js';
import {drawWarriorGear} from './warrior-gear.js?v=0.21.0';
import {cleanSpriteMatte,cleanGreenMatte} from './sprite-matte.js?v=0.21.0';
