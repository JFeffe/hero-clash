import {ensureWallet} from './wallet.js?v=0.28.7';
import {ensureCareer,resolvePool,advanceCareer,markBot} from './career.js?v=0.28.7';
import {acquireItem,resetArenaAfterBattle} from './hero-state.js?v=0.28.7';
import {D,randomItem,applyResult,battleRewards} from './engine.js?v=0.26.0';
